...
const SubtaskForm = ({ setSubtaskFormRendered, 
    ...
    const addSubtask = (data) => {
        ...
        calculate(newSubtask, newSubtask.total, newSubtask.task_id, 'add')
    }
    ...
    const editSubtask = (data) => {
        ...
        setEditSubtaskData(null)
        setSubtaskFormRendered(false)
        calculate(newSubtask, newSubtask.total, newSubtask.task_id, 'edit', editSubtaskData.total, newSubtask.total)
    }
