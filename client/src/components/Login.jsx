...
//
  ...
  return (
    <form className='grid bg-blue-600 border rounded border-blue-600 p-5'>
        ...
        <button className='bg-orange-400 border-orange-400 border rounded border-blue-500 my-1'>Log In</button>
        <button className='bg-orange-400 border-orange-400 border rounded border-blue-500 my-1'>Log In As Guest</button>
        <button className='bg-orange-400 border-orange-400 border rounded border-blue-500 my-1'>Create an Accout</button>
    </form>
  )
}
