...
const NewEstimateEmail = ({
  ...
  return (
    <Html>
      <Head />
      <Preview>View your new estimate!</Preview>
      <Body style={main}>
        <Container style={container}>
          <Section style={box}>
            ...
            <Text style={paragraph}>
              {`Hello ${customerName}, ${contractorName} has created a new estimate for you!`}
            </Text>
            <Text style={paragraph}>
              Click the link below to view your new estimate!
            </Text>
            <Button style={button} href={url}>
              View your New Estimate
            </Button>
            {/* <Hr style={hr} /> */}
            {/* <Text style={paragraph}>
