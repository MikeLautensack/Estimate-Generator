...
const NewCustomerEmail = ({
  ...
  return (
    <Html>
      <Head />
      <Preview>{`You are now a customer of ${contractorName}`}!</Preview>
      <Body style={main}>
        <Container style={container}>
          <Section style={box}>
            ...
            <Text style={paragraph}>
              {`Hello ${customerName}, ${contractorName} has added you as a new customer to their contractor account!`}
            </Text>
            <Text style={paragraph}>
              Click the link below to view your customer dashboard!
            </Text>
            <Button style={button} href={url}>
              View your Customer Dashboard
            </Button>
            {/* <Hr style={hr} /> */}
            {/* <Text style={paragraph}>
