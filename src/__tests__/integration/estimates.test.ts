...
describe("POST /api/v1/estimates", () => {
  ...
  test("should create a draft estimate successfully", async () => {
    // Arrange
    const num = 1;
    // const mockUser = {
    //   id: "user-123",
    ...
    // mockCreateDraft.mockResolvedValue(mockCr eatedEstimate);
  ...
  //   test("should handle errors during estimate creation", async () => {
  //     // Arrange
  //     const mockUser = {
  //       id: "user-123",
  //       email: "contractor@example.com",
  ...
  //   test("should handle missing customerId in request body", async () => {
  //     // Arrange
  //     const mockUser = {
  //       id: "user-123",
  //       email: "contractor@example.com",
