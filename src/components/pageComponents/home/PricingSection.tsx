...
export default function PricingSection() {
  ...
  return (
    <section
      id="pricing"
      className="w-full flex flex-col items-center desktop:h-screen bg-primary200"
    >
      <div className="my-4">
        {/**
         * Heading
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <h3 className="text-2xl font-bold text-primary500 text-center">
            Choose the Estimate Generator plan that fits your needs
          </h3>
        </div>
        ...
        <div className="flex justify-center items-center gap-4 mt-4">
          ...
          <Switch className="" onCheckedChange={() => click(subRateType)} />
