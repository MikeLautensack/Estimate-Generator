...
const ProfileForm = () => {
  ...
  return (
    ...
    >
      <h1 className="text-[32px] font-bold font-sans text-secondary500 text-center">
        Complete Profle
      </h1>
      <div className="flex flex-col items-center tablet:flex-row">
        <div className="flex flex-col w-1/2 p-2">
          <h2 className="text-[18px] font-bold font-sans text-secondary500 text-center">
            Profile Photo
          </h2>
          <div className="flex flex-col gap-2 tablet:flex-row my-2 items-center">
            ...
            <div className="flex flex-col tablet:w-1/2 justify-center gap-2">
              <Button className="text-base font-medium font-sans text-primary500 border-2 border-primary500 rounded p-1">
                Upload Photo
              </Button>
              <Button className="text-base font-normal font-sans text-primary300">
                Remove
              </Button>
            </div>
          </div>
        ...
        <div className="p-2">
          <h2 className="text-[18px] font-normal font-sans text-secondary500">
            Image requirments:
          </h2>
          <ol className="">
            <li className="text-[14px] font-normal font-sans text-secondary500">
              1. Min. 400 x 400px
            </li>
            <li className="text-[14px] font-normal font-sans text-secondary500">
              2. Max. 2MB
      ...
      <div className="">
        <h3 className="text-[18px] font-bold font-sans text-secondary500">
          Profile Details
        </h3>
        <div className="">
        ...
        <div className="w-full flex justify-end">
          <Button className="bg-primary500 text-primary100 p-2 my-2 rounded">
            Save
          </Button>
        </div>
      </div>
