    ...
    >
      ...
      <div className="flex flex-col w-full gap-14">
        <div className="flex flex-col gap-4 w-full">
          <h1
            className={`text-xl font-bold ${isOpen ? "text-white text-center" : ""} text-black desktop:text-center`}
          >
            Estimate Generator
          </h1>
          <nav
            className={`${isOpen ? "flex" : "hidden"} desktop:flex justify-center items-center gap-4 w-full`}
          >
            <Link
              id="profile-button"
            ...
            <Link id="settings-button" className="" href="/settings/account">
              <FcSettings />
            </Link>
