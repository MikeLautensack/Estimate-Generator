...
const SubscriptionCard = ({
  ...
  return (
    <div className="flex flex-col gap-2 items-center px-6 py-12 basis-full h-full bg-primary100 rounded hover:shadow-md hover:shadow-primary500 hover:scale-[1.03]">
      <h4 className="text-[32px] font-bold text-primary500 text-center">
        {heading}
      </h4>
      <p className="text-base font-normal text-primary500 text-center">
        {paragraph}
      </p>
      ...
      <Button className="bg-primary500 text-primary100 text-xl font-medium p-4 rounded">
        Get Started
      </Button>
      <div className="">
        {
          <ul className="">
            {featuresArray.map((feature) => (
              <li
                className="flex gap-2 items-center text-[18px] font-normal"
                key={featuresArray.indexOf(feature)}
              >
